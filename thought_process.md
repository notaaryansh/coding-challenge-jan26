...
Step 2) Now we will do A intersect B intersect C
...
Step 5) If we get a non null set; we will return it. If not; we can suggest some profiles with "softly" fit the preference. 
